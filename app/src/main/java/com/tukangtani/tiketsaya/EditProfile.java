...
public class EditProfile extends AppCompatActivity {
    ...
    Button btn_save, btn_add_new_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_new_profile = findViewById(R.id.btn_add_new_photo);
                ...
                if (photo_location != null){
                    ...
                    storageReference1.putFile(photo_location).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            Intent gotobackprofile = new Intent(EditProfile.this, my_profile.class);
        ...
        btn_add_new_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                findphoto();
            }
