...
public class my_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_my_tiket = findViewById(R.id.item_my_ticket);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(my_profile.this).load(dataSnapshot.child("url_photo_profile")
        ...
        reference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ticketAdapter = new TicketAdapter(my_profile.this, list);
        ...
        btn_sign_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //berpindap activity
                Intent gotohome = new Intent(my_profile.this, SigninAct4.class);
